					...
					<form id="signDialog-form" action="" method="POST">
			      	...
			      	<script type="text/javascript">//<![CDATA[	
			      		...
			      		function checkZIndex() {			      			
			      			...
			      			if(zIndex > 0) {
			      				//alert("Pantalla con foco.");
			      				window.clearInterval(loadingFrameInterval);		  		      				
			      				YAHOO.util.Dom.get("sign-component").innerHTML="<iframe scrolling='no' frameborder='0' allowTransparency='true' id='sign-frame' src='/share/sign/sign-frame.jsp' style='overflow:hidden;width:100%;border:none;height:0px;' />";			      				
			      		...
			      		function doSign() {
			      			...
			      			if(miniApplet != null) {
			      				...
			      				signFrame.contentWindow.doSign(signForm.dataToSign, signForm.signedData, signForm.signerData);
			      				show_signed();
			      				//alert(signForm.signedData.value);		      				
			      			}						      					      			
			      		};
